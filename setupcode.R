...
rna_seq_analysis <- function(counts_file = "E-MTAB-2523.counts.txt",
  ...
  counts <- read.table(counts_file, header = TRUE, row.names = 1, sep = "\t")  # Assuming tab-separated values
  sample_table <- read.table(sample_table_file, header = TRUE, row.names = 1, sep = "\t")  # Assuming tab-separated values
